                ...
                <div className="mt-8 w-full">
                    <div className="space-y-4">
                        {prompts.map((prompt, index) => (
                            <div key={index} className="flex items-start justify-between gap-4 bg-slate-800/40 p-4 rounded-lg border border-slate-700">
                                ...
                                <button
                                    ...
                                    title="Copy prompt"
                                    className="p-2 text-gray-400 bg-slate-700 rounded-md hover:bg-slate-600 hover:text-white transition-colors duration-200"
                                >
